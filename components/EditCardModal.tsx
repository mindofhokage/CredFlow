...
const inputClass = cn(
  'w-full px-3.5 py-2.5 text-[14px] text-[#1D1D1F] rounded-xl border border-black/[0.08] bg-[#F5F5F7] focus:bg-white focus:border-black/20 focus:ring-2 focus:ring-black/[0.04] outline-none transition-all duration-200 placeholder:text-[#AEAEB2]',
)
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-3xl overflow-hidden"
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-black/[0.06]">
          <h2 className="text-[17px] font-semibold tracking-tight text-[#1D1D1F]">Modifier la carte</h2>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#6E6E73] uppercase tracking-wider mb-2">Fournisseur</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#6E6E73] uppercase tracking-wider mb-2">URL du logo</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#6E6E73] uppercase tracking-wider mb-2">Début de facturation</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#6E6E73] uppercase tracking-wider mb-2">4 derniers chiffres</label>
            ...
            <div className="border-t border-black/[0.06] pt-3 mt-1">
              {!confirmDelete ? (
                <button type="button" onClick={() => setConfirmDelete(true)}
                  className="w-full py-2.5 text-[14px] text-red-500 hover:bg-red-50 rounded-2xl transition-colors flex items-center justify-center gap-2">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button type="button" onClick={() => setConfirmDelete(false)}
                      className="py-2.5 bg-[#F5F5F7] hover:bg-[#E5E5EA] text-[#1D1D1F] text-[14px] font-medium rounded-2xl transition-colors">
                      Annuler
                    </button>
